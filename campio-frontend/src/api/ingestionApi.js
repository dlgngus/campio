...
export const ingestionApi = {
  ...
  deleteSource: (id) => request(`${basePath}/sources/${id}`, { method: "DELETE" }),
  ...
  updateRawStatus: (id, body) => request(`${basePath}/raw-opportunities/${id}/status`, { method: "PATCH", body: JSON.stringify(body) }),
  publishRawOpportunity: (id, body) => request(`${basePath}/raw-opportunities/${id}/publish`, { method: "POST", body: JSON.stringify(body) }),
};
